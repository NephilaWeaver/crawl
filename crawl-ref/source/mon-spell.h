...
static const mon_spellbook mspell_list[] =
{
    ...
    {  MST_ANNIHILATOR,
      {
       ...
       { SPELL_DELIQUESCENCE, 11, MON_SPELL_WIZARD },
    ...
    {  MST_ANCIENT_CHAMPION,
      {
       { SPELL_DELIQUESCENCE, 21, MON_SPELL_WIZARD },
    ...
    {  MST_YNOXINUL,
      {
       { SPELL_DELIQUESCENCE, 19, MON_SPELL_MAGICAL },
    ...
    {  MST_JORGRUN,
      {
       ...
       { SPELL_DELIQUESCENCE, 16, MON_SPELL_WIZARD },
    ...
    { MST_ROXANNE,
      {
       { SPELL_BOLT_OF_MAGMA, 13, MON_SPELL_WIZARD },
       { SPELL_DELIQUESCENCE, 13, MON_SPELL_WIZARD },
    ...
    {  MST_FRANCES,
      {
       ...
       { SPELL_DELIQUESCENCE, 12, MON_SPELL_WIZARD },
    ...
    {  MST_CEREBOV,
      {
       { SPELL_DELIQUESCENCE, 11, MON_SPELL_MAGICAL },
